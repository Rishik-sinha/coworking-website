...
const Footer = () => {
  ...
  return (
    <>
      {/* CHANGE: Removed bg-black from the parent to reveal the rounded corners of the child div. */}
      <footer className="relative">
        <motion.div
          className="h-[60vh] w-full rounded-t-[40px] bg-black text-white flex items-center"
